 ...
 */
export function renderPageGraph(stem: string, graphData: GraphData, template: string): string {
...
export function buildPage(stem: string, model: SiteModel, templates: PageTemplates): string {
