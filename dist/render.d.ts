...
export declare function buildPage(stem: string, pages: Map<string, PageInfo>, backlinks: Map<string, string[]>, template: string, config: SiteConfig, graphData?: GraphData): string;
